  ...
  return (
    <section className={styles.landing}>
      ...
      <p>
        ...
        description of how I interpreted these guidelines. I&apos;ve selected
        six different guidelines in which I feel I&apos;m currently lacking,
        included with a brief strategy on how I would like to improve this
        aspect of my media literacy. My long-term plan is quickly outlined in
        the following section, where I detail the steps I&apos;ll take to ensure
        these changes aren&apos;t short lived.
      </p>
    </section>
  );
}
